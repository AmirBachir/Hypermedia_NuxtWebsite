export default async (models) => {
  ...
  const pointsOfInterest = [  
    ...
    },
    {
      ...
      thumbnail: 'dat.jpg',
      address: ' via Trieste, 17',
      opening_hours:'Tuesday - Sunday: 10:00 - 18:00',
      fee:10,
    },
    {
      name: "Querini Library",
      intro: "The Biblioteca Queriniana was established in 1747 from Brescia's bishop, the card. Angelo Maria Querini, which has established the public use destination of the library and provided also to the construction of the palazzo that still today is the headquarter. It was opened to the public in 1750 and, for some successive decades, it also served as a museum and as the seat of the city's scholarly academy.",
      // details:"",
      cover_img: 'Querini_Library.png',
      img: "i_QL.png",
      img_caption: "Details of furniture inside the library",
      thumbnail: 'qlt.jpg',
      address: 'Via Mazzini, 1',
      opening_hours:'Tuesday - Sunday: 10:00 - 18:00',
      fee:4,
    },
    {
      ...
      thumbnail: 'pbt.jpg',
      address: 'Via Cardinal Querini, 9',
      opening_hours:'Tuesday - Sunday: 10:00 - 18:00',
      fee:5,
    },
    {
    ...
    },
    {
      ...
      thumbnail: 'tgt.jpg',
      address: 'Corso Giuseppe Zanardelli, 9/A',
  ...
  const events = [
    ...
    },
    {
      ...
      intro: 'The most important appointment in Brescia, you cannot miss!',
      season: 'summer',
